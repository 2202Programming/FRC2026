...
public class RobotSpec_AlphaBot implements IRobotSpec {
  ...
  public ModuleConfig[] getModuleConfigs() {
    ...
    modules[CornerID.FrontLeft.getIdx()] = new ModuleConfig(CornerID.FrontLeft,
        CAN.FL_CANCoder, CAN.FL_Drive, CAN.FL_Angle, -21.089)//old -20.474
        .setInversions(false, true, true);

    modules[CornerID.FrontRight.getIdx()] = new ModuleConfig(CornerID.FrontRight,
        CAN.FR_CANCoder, CAN.FR_Drive, CAN.FR_Angle, -104.155)//old -105.737
    ...
    modules[CornerID.BackLeft.getIdx()] = new ModuleConfig(CornerID.BackLeft,
        CAN.BL_CANCoder, CAN.BL_Drive, CAN.BL_Angle, -168.842)//old -163.305
        .setInversions(false, true, true);

    modules[CornerID.BackRight.getIdx()] = new ModuleConfig(CornerID.BackRight,
        CAN.BR_CANCoder, CAN.BR_Drive, CAN.BR_Angle, 102.023)//101.936
        .setInversions(true, true, true);
