...
public class RobotSpec_BotOnBoardZeta implements IRobotSpec {
  // $env:serialnum = "0312db1a"
  final SubsystemConfig ssconfig = new SubsystemConfig("BotOnBoardZeta", "0312db1a")
  ...
  public RobotSpec_BotOnBoardZeta() {
